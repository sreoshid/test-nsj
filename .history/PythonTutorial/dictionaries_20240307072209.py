...
sample_dict_new = {"name":sample_dict["name"], "salary":sample_dict["salary"]}

print(sample_dict_new)
...
# sample_dict = sample_dict.pop("name", "salary")
...
# print(sample_dict.get)

minumum_value = min(sample_dict, key=sample_dict.get)
...
dict1 = [30, 40, 50]
dict2 = ['Thirty', 'Fourty', 'Fifty']

dict_result = {}
for data, key in dict1, dict2:
    dict_result = {key:data}.append()
