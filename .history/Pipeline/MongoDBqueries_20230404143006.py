...
import sys 
import os
sys.path.append(os.path.abspath("C:\Users\srdasg\python\Pipeline\MongoDBqueries.py"))
from riaa import *
...
def find_latest_createDate(code):
    query_filter = cprmsCorrelationMetadata.find({'correlationStatus': 'SUCCESSFUL','clientCode' : code})
