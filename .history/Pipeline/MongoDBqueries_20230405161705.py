...
def statCorrltnStatus(code, latest_create_date, rollback_date):
    statCorrltn_trnsfmd_count = cprmsStatisticsCorrelation.count_documents({'clientCode' : code, 'status' : 'UNPROCESSED', 
                                                  'createDate' : {'$gte': rollback_date,'$lte': latest_create_date}})
    return statCorrltn_trnsfmd_count
