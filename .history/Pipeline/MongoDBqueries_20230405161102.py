...
def statCorrltnPngStatus(code, latest_create_date, rollback_date):
    statCorrltn_ignrd_count = cprmsStatisticsCorrelation.count_documents({'clientCode' : code, 'status' : 'PENDING', 
                                                  'createDate' : {'$gte': rollback_date,'$lte': latest_create_date}})
    return statCorrltn_ignrd_count
