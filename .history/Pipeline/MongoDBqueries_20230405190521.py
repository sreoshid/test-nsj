...
def getTransformedTxnsCount(code, rollback_date):
    ...
    accepted_state_count = skiDataEntryExit.count_documents({'clientCode' : code, 'status' : 'ACCEPTED', 
                                                  'createDate' : {'$gte': rollback_date,'$lte': rollback_date}})
    ignored_state_count = skiDataEntryExit.count_documents({'clientCode' : code, 'status' : 'ACCEPTED', 
                                                  'createDate' : {'$gte': rollback_date,'$lte': rollback_date}})
    pending_state_count = skiDataEntryExit.count_documents({'clientCode' : code, 'status' : 'ACCEPTED', 
                                                  'createDate' : {'$gte': rollback_date,'$lte': rollback_date}})
    rejected_state_count = skiDataEntryExit.count_documents({'clientCode' : code, 'status' : 'ACCEPTED', 
                                                  'createDate' : {'$gte': rollback_date,'$lte': rollback_date}})
    unprocessed_state_count = skiDataEntryExit.count_documents({'clientCode' : code, 'status' : 'ACCEPTED', 
                                                  'createDate' : {'$gte': rollback_date,'$lte': rollback_date}})
    failed_state_count = skiDataEntryExit.count_documents({'clientCode' : code, 'status' : 'ACCEPTED', 
                                                  'createDate' : {'$gte': rollback_date,'$lte': rollback_date}})
    duplicate_state_count = skiDataEntryExit.count_documents({'clientCode' : code, 'status' : 'ACCEPTED', 
                                                  'createDate' : {'$gte': rollback_date,'$lte': rollback_date}})
    deleted_state_count = skiDataEntryExit.count_documents({'clientCode' : code, 'status' : 'ACCEPTED', 
                                                  'createDate' : {'$gte': rollback_date,'$lte': rollback_date}})
    to_be_deleted_state_count = skiDataEntryExit.count_documents({'clientCode' : code, 'status' : 'ACCEPTED', 
                                                  'createDate' : {'$gte': rollback_date,'$lte': rollback_date}})
    error_state_count = skiDataEntryExit.count_documents({'clientCode' : code, 'status' : 'ACCEPTED', 
                                                  'createDate' : {'$gte': rollback_date,'$lte': rollback_date}})
    return transformed_state_count
