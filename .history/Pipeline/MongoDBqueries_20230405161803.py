...
def statCorrltnFdStatus(code, latest_create_date, rollback_date):
    statCorrltn_Unprcsd_count = cprmsStatisticsCorrelation.count_documents({'clientCode' : code, 'status' : 'FAILED', 
                                                  'createDate' : {'$gte': rollback_date,'$lte': latest_create_date}})
    return statCorrltn_Unprcsd_count
