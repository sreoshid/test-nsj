...
def metaDataSuccessfulCountStatus(createDate, rollback_date):
    query_filter = cprmsCorrelationMetadata.find({'clientCode' : code, 'correlationStatus' : 'SUCCESSFUL', 
                                                  'createDate' : {'$gte': rollback_date'$lte': createDate}})
