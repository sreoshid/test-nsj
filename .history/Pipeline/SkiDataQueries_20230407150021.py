...
def getSkiDataErrorTxnsCount(code, rollback_date, correlation_metadata_id):
    error_state_count = skiDataRevenueTicket.count_documents({'clientCode' : code, 'status' : 'ERROR', 
                                                          'correlationMetadataId' : {'$in': correlation_metadata_id},
                                                  'createDate' : {'$gte': rollback_date,'$lte': rollback_date}})
    return error_state_count