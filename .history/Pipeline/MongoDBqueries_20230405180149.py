...
def getStatCorrelationId(code, latest_create_date, rollback_date):
    ...
    for document in query_filter:
        correlation_metadata_id = document.get('propertyCode')
        correlation_metadata_id = correlation_metadata_id.append(statestics_corr_id)
...
def getStatCorrelationId(code, latest_create_date, rollback_date):
    ...
    for document in query_filter:
        statestics_corr_id = document.get('propertyCode')
