...
def getTransformedTxnsCountBeforeRollback(code, rollback_date):
    transformed_state_count = cprmsStatisticsCorrelation.count_documents({'clientCode' : code, 'status' : 'TRANSFORMED', 
                                                  'createDate' : {'$gte': rollback_date,'$lte': rollback_date}})
    accepted_state_count = cprmsStatisticsCorrelation.count_documents({'clientCode' : code, 'status' : 'TRANSFORMED', 
                                                  'createDate' : {'$gte': rollback_date,'$lte': rollback_date}})
