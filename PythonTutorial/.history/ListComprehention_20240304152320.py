...
new_list = ["Fizz" if num % 3 == 0  else "Buzz" if num % 5 == 0 else "FizzBuzz" if num % 3 == 0 and num % 5 == 0 else num for num in numbers]
...
list2 = [list(i**2) for i in list1.index(list1)]
